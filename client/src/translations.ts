...
export const translations: Record<Lang, Translations> = {
  en: {
    ...
    gift: {
      ...
      intro:
        "Give the gift of Post From Provence — a handcrafted envelope mailed every month to someone you love. It's billed monthly to your card and can be cancelled anytime, so there's no pressure to commit to a full year. Choose where your recipient lives so we can get the shipping right.",
      euLabel: "Recipient in France",
      euNote: "Billed monthly, cancel anytime",
      intlLabel: "Recipient outside France",
      intlNote: "Billed monthly, cancel anytime",
    ...
    subscribe: {
      ...
      euIntro: "For subscribers living in France.",
      intlHeading: "International Subscriptions",
      intlIntro: "For subscribers living outside France.",
  ...
  fr: {
    ...
    gift: {
      ...
      intro:
        "Offrez Post From Provence — une enveloppe faite main envoyée chaque mois à quelqu'un que vous aimez. La facturation est mensuelle sur votre carte et peut être annulée à tout moment, sans pression de vous engager pour une année entière. Choisissez où vit votre destinataire pour que nous puissions calculer les frais d'envoi correctement.",
      euLabel: "Destinataire en France",
      euNote: "Facturation mensuelle, annulez à tout moment",
      intlLabel: "Destinataire hors de France",
      intlNote: "Facturation mensuelle, annulez à tout moment",
    ...
    subscribe: {
      ...
      euIntro: "Pour les abonnés vivant en France.",
      intlHeading: "Abonnements internationaux",
      intlIntro: "Pour les abonnés vivant hors de France.",
